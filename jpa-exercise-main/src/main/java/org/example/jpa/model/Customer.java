...
@Entity
@Builder // provides a clean and readable way to create object
@Data // generate the getter,setters and tostring
@AllArgsConstructor // generate the constructor for all argument
@NoArgsConstructor      // generate the constructor for no argument
